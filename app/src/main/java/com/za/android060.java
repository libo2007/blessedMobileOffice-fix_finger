...
public class android060 {
	 ...
	 *iCom 串口号（1-16）（USB 设备和无驱 UDISK 设备该参数为 0）；
	 *  0-7     "/dev/ttySx",
	 *  10-17   "/dev/ttyMTx"
	 *  20-27   "/dev/ttysWKx"
	 *  30-37   "/dev/ttyHSLx"
	 ...
	 *0 为成功，其它返回值请参考错误返回码
	 ********************************************************************/
	public native int ZAZUpImage(int nAddr,char[] pImageData,int[] iTempletLength);
	/*******************************************************************
	 *13、下载图像函数
	 *参数：
	 *nAddr： 0xffffffff ；
	 ...
	 *0 为成功，其它返回值请参考错误返回码
	 ********************************************************************/
	public native int ZAZDownImage(int nAddr,char[] pImageData, int iLength);
	/*******************************************************************
	 *14、图像数据保存成 BMP 图片函数
	 *参数：
	...
	public native int ZAZImgData2BMP(char[] pImgData,String str);
	/*******************************************************************
	 ...
	 *0 为成功，其它返回值请参考错误返回码
	 ********************************************************************/
	public native int ZAZGetImgDataFromBMP(String str,char[] pImageData,int[] pnImageLen);
	 ...
	 *0 为成功，其它返回值请参考错误返回码
	 ********************************************************************/
	public native int ZAZReadParTable(int nAddr,char[] pParTable);
	/*******************************************************************
	 *19、快速比对函数
	 *参数：
	 *nAddr： 0xffffffff ；
	 ...
	 *0 为成功，其它返回值请参考错误返回码
	 ********************************************************************/
	public native int ZAZSetPwd(int nAddr,char[] pPassword);
	/*******************************************************************
	 *22、验证设备握手口令函数
	 *参数：
	 *nAddr： 0xffffffff ；
	 ...
	 *0 为成功，其它返回值请参考错误返回码
	 ********************************************************************/
	public native int ZAZVfyPwd(int nAddr,char[] pPassword);
	/*******************************************************************
	 *23、读取用户信息函数
	 *参数：
	 *nAddr： 0xffffffff ；
	 ...
	 *0 为成功，其它返回值请参考错误返回码
	 ********************************************************************/
	public native int ZAZReadInfo(int nAddr,int nPage,char[] UserContent);
	/*******************************************************************
	 *24、写入用户信息函数
	 *参数：
	 *nAddr： 0xffffffff ；
	 ...
	 *0 为成功，其它返回值请参考错误返回码
	 ********************************************************************/
	public native int ZAZWriteInfo(int nAddr,int nPage,char[] UserContent);
	/*******************************************************************
	 *25、设置波特率函数
	 *参数：
	 *nAddr： 0xffffffff ；
	 ...
	 *0 为成功，其它返回值请参考错误返回码
	 ********************************************************************/
	public native int ZAZUpChar2File(int nAddr,int iBufferID, char[] pFileName);
	 ...
	 *0 为成功，其它返回值请参考错误返回码
	 ********************************************************************/
	public native int ZAZDownCharFromFile(int nAddr,int iBufferID, char[] pFileName);
	/*******************************************************************
	 *30、获取随机数函数
	 *参数：
	 *nAddr： 0xffffffff ；
	 ...
	 *0 为成功，其它返回值请参考错误返回码
	 ********************************************************************/
	public native int ZAZGetRandomData(int nAddr,char[] pRandom);
	 ...
	 *0 为成功，其它返回值请参考错误返回码
	 ********************************************************************/
	public native int ZAZSetChipAddr(int nAddr,char[] pChipAddr);
